...
<div class="form-container">
    <div class="form-card">
        <div class="form-header">
            <h1 class="form-title">Report Lost or Found Item</h1>
            <p class="form-subtitle">Share details to help reconnect people with their belongings</p>
        </div>
        ...
        <div class="form-content">
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" id="contact_phone" name="contact_phone" class="form-input" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <button type="submit" class="submit-button">Publish Your Post</button>
                </div>
            </form>
        </div>
    </div>
